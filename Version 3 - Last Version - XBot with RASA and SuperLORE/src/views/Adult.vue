  ...
  <b-container>
    <div id="adult">
      ...
      >
          ...
          <b-col class="position-relative">
            ...
            >
              <b-card-text
                ...
                <h5>
                  <b-badge variant="dark"
                    >{{ class_adult.class_prob }}%</b-badge
                  >
                </h5>
              </b-card-text>
            </b-card>
        ...
        <br />
        <b-sidebar id="sidebar-1" title="Adult" shadow="true">
...
export default {
  ...
  methods: {
    start_to_explain_instance(event) {
      ...
      getSingleEndpoint(this.form, "adult_lore_explanation").then((res) => {
